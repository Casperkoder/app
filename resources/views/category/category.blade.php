<x-admin-layout>
                        ...
                        @foreach($category->properties  as $property)
                            <tr>
                                <td>
                                    ...
                                    <button onclick="updateProperty('{{route('update-property',$property->id)}}', '{{$property->name}}','{{$property->type}}');"
    ...
    <script>
        ...
        // name ve type'ı özellik kısmında butonun içinde gözüksün diye ekledik
        function updateProperty(url,name,type) {
            $('#propertyForm [name=_method]').val('put');
            $('#propertyForm [name=property_name]').val(name);
            $('#propertyForm [name=property_type]').val(type);
                    ...
                    <form method="post" id="propertyForm">
                        ...
                        <div class="form-group ">
                            ...
                            <select class="form-control" name="property_type">
                                ...
                                <option value="checkbox">Birden fazla seçim</option>
                            </select>
                        </div>
