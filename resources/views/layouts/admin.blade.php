        ...
        <div class="nano-content">
            <ul>
                <div class="logo"><a href="{{route('dashboard')}}">
                        <img src="{{asset('/admintema/images/logo.png')}}" alt=""/> <span>SİMURG</span></a></div>

                <li><a href="{{route('home-start')}}"><i class="ti-home"></i> Anasayfa </a></li>
                <li><a class="sidebar-sub-toggle"><i class="ti-layout"></i> Ürün İşlemleri <span
                    ...
                    <ul>
                        ...
                        <li ><a href="{{route('get-all-products')}}" > Ürün Yönetimi</a></li>
                    </ul>
                </li>
                <li><a class="sidebar-sub-toggle" ><i class="ti-user"></i> Kullanıcı İşlemleri<span
                            class="sidebar-collapse-icon ti-angle-down"></span> </a>
                    <ul>
                        <li ><a href="{{route('get-all-users')}}" > Kullanıcı Yönetimi</a></li>
