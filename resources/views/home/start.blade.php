            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{asset('/hometema/images/p1.png')}}" alt="">
                            </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{'/hometema/images/p2.png'}}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                  Kol  Saati
...
{{--                ayıcık ürün resim--}}
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{asset('/hometema/images/p3.png')}}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Oyuncak Ayı
...
{{--                çiçek resim--}}
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{'/hometema/images/p4.png'}}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Çiçek Buketi
...
{{--            büyük olan    teady ayıcık resim--}}
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{'/hometema/images/p5.png'}}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                   Oyuncak Ayı
...
{{--                mor çiçek --}}
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{'/hometema/images/p6.png'}}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                  Çiçek Buketi
...
{{--                saat kırmızı resim--}}
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{'/hometema/images/p7.png'}}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Kol Saati
...
{{--                tek taş yüzük--}}
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="">
                            <div class="img-box">
                                <img src="{{'/hometema/images/p8.png'}}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    Tek Taş Yüzük
        ...
        <div class="box">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="img-box">
                                {{--elinde poşet olan kız resmi--}}
                            <img src="{{'/hometema/images/saving-img.png'}}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="detail-box">
    ...
    <section class="why_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    NEDEN BİZİMLE ALIŞVERİŞ YAPMALISINIZ
                </h2>
            </div>
            <div class="row">
                <div class="col-md-4">
...
k                                <g>
                 ...
                 C281.901,181.576,281.901,176.501,278.771,173.37z"/>
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                Hızlı teslimat seçeneği mevcuttur
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <g>
                 ...
                 c5.888,0,10.667-4.779,10.667-10.667S379.221,234.667,373.333,234.667z"/>
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                Size özel ücretsiz kargo ile keyifle alışveriş yapın.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="img_container">
                            <div class="img-box">
                                    {{--  mor kısmın balon resim kodu--}}
                                <img src="{{'/hometema/images/gifts.png'}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="detail-box">
                            <div class="heading_container">
                                <h2>
                                   Sevdikleriniz İçin <br>
                                    Hediyeler
                                </h2>
                            </div>
                            <p>
                                "Tüm bunların sevgiyle nefret ettiği, suçlamaların ve yolsuzlukların altında kalan,
                                güzelliklerin ve şeffaflığın içerisinde eksiklikler taşıyan bir yaşam mı?"
                                "Mutluluk ya da başka bir şeyin ardından koşmak,
                                bazı şeyleri elde etmek ve bu şekilde ilerlemek,
                                iddiaları hızlı bir şekilde ele geçirenler tarafından mı yapılıyor?"
                            </p>
                            <div class="btn-box">
                                <a href="#" class="btn1">
                                    Şimdi Satın Al
